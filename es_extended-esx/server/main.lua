...
AddEventHandler('esx:giveInventoryItem', function(target, type, itemName, itemCount)
	...
	if type == 'item_standard' then
		...
		if itemCount > 0 and sourceItem.count >= itemCount then
			...
			MySQL.Async.execute('INSERT INTO log_transfer (Sender, Type, Amount, Reciever)VALUES (@Sender, @Type, @Amount, @Reciever) ',{
...
AddEventHandler('esx:removeInventoryItem', function(type, itemName, itemCount)
	...
	if type == 'item_standard' then
		if itemCount == nil or itemCount < 1 then
			...
			MySQL.Async.execute('INSERT INTO log_hardlog (Sender, Type, Amount, Reciever)VALUES (@Sender, @Type, @Amount, @Reciever) ',{
				['@Sender']   = xPlayer.name,
				['@Type']   =	itemName,
				['@Amount']    = itemCount,
				['@Reciever']    = 'Sildi'  })				
